...
const { createPost, getPosts, getQueryPost } = require('./controllers/post.controller');
...
app.get('/post/:id', validateToken, getPosts);
app.get('/search', validateToken, getQueryPost);
module.exports = app;
